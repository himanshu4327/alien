...
import { BUSD, CAKE, USDC, ALIEN } from '@pancakeswap/tokens'
...
export const useCakeBusdPrice = (
  ...
  const cake: Token = isTestnet ? CAKE[ChainId.BSC_TESTNET] : CAKE[ChainId.ARBITRUM]
...
export const useBNBBusdPrice = (
  ...
  const wbnb: Token = isTestnet ? WBNB[ChainId.BSC_TESTNET] : WNATIVE[ChainId.ARBITRUM]
