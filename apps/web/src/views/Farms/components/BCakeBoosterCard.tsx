...
export const useBCakeTooltipContent = () => {
  ...
  const tooltipContent = (
    <>
      <Box mb="20px">
        {t(
          'Yield Boosters allow you to boost your farming yields by locking Alien in the fixed-term staking Alien pool. The more Alien you lock, and the longer you lock them, the higher the boost you will receive.',
        )}
      </Box>
      <Box>
    ...
    return (
      <Box>
        ...
        <Text color="textSubtle" fontSize={12} mb="16px">
          {t('An active fixed-term Alien staking position is required for activating farm yield boosters.')}
        </Text>
