...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and Alien pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and Alien pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from Alien pool', data)
  }
