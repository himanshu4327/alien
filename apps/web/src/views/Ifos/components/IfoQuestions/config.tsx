...
const config = [
  {
    ...
    description: [
      <Trans>
        ...
        Alien up to the maximum commit limit, which is published along with the IFO voting proposal. The Private Sale
      ...
      <Trans>
        ...
        users can commit, is equal to the number of iAlien they have.
      </Trans>,
      <>
  ...
  },
  {
    ...
    description: [<Trans>The Alien from the participation fee will be burnt as part of the weekly token burn.</Trans>],
  },
  {
    title: <Trans>How can I get an achievement for participating in the IFO?</Trans>,
    description: [
      <Trans>You need to contribute a minimum of about 10 USD worth of Alien to either sale.</Trans>,
      <Trans>
