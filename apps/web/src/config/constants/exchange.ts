...
import { bscTokens, bscTestnetTokens, arbitrumTokens, USDC, USDT, BUSD, WBTC_ETH, WBTC_ARBITRUM, DAI_ARBITRUM } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.ARBITRUM]: '0x863e9610E9E0C3986DCc6fb2cD335e11D88f7D5f',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.ARBITRUM]: [WNATIVE[ChainId.ARBITRUM], USDC[ChainId.ARBITRUM], USDT[ChainId.ARBITRUM], WBTC_ARBITRUM, DAI_ARBITRUM],
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.ARBITRUM]: [USDC[ChainId.ARBITRUM], USDT[ChainId.ARBITRUM], WNATIVE[ChainId.ARBITRUM], WBTC_ARBITRUM, DAI_ARBITRUM],
}
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.ARBITRUM]: [USDC[ChainId.ARBITRUM], WNATIVE[ChainId.ARBITRUM], USDT[ChainId.ARBITRUM], WBTC_ARBITRUM],
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  //   [WBTC_ETH, WNATIVE[ChainId.ARBITRUM]],
